...
1. `best.pt`: Model hasil pelatihan berbobot optimal (*weights*).
2. `train.py`: Script untuk melakukan training model dengan deteksi otomatis GPU CUDA / CPU fallback.
